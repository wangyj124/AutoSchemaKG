...
class BaseEmbeddingModel(ABC):
    ...
    def compute_kg_embedding(self, node_csv_without_emb, node_csv_file, edge_csv_without_emb, edge_csv_file, text_node_csv_without_emb, text_node_csv, **kwargs):
        with open(node_csv_without_emb, "r", encoding='utf-8') as csvfile_node:
            with open(node_csv_file, "w", newline='', encoding='utf-8') as csvfile_node_emb:
        ...
        with open(edge_csv_without_emb, "r", encoding='utf-8') as csvfile_edge:
            with open(edge_csv_file, "w", newline='', encoding='utf-8') as csvfile_edge_emb:
        ...
        with open(text_node_csv_without_emb, "r", encoding='utf-8') as csvfile_text_node:
            with open(text_node_csv, "w", newline='', encoding='utf-8') as csvfile_text_node_emb:
